...
> **Setting up this project on a fresh server? Read [`REPRODUCE.md`](REPRODUCE.md) first** —
> environment, directory layout, which HF repos hold the models/datasets/teacher-caches,
