#!/usr/bin/env bash
# DAPO + JEPA (jepa-tcr-dual) | Qwen2.5-Math-1.5B-Instruct | Ray + FSDP + hybrid-engine vLLM
# Dual view: 4 CoT + 4 Code rollouts/prompt, both in the DAPO loss. Code-view
# responses are EXECUTED and scored on their printed answer
...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-dapo_jepa-${MODEL_NAME}-${RUN_TIMESTAMP}}
