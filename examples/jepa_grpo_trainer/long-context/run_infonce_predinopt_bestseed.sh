...
# New wandb run that inherits run b37smc10's history up to the step-50 checkpoint,
# then continues logging as its own run from that point.
export JEPA_WANDB_FORK_FROM="b37smc10?_step=50"
exec /workspace/exploration/.venv/bin/python3 -m verl.experimental.jepa_grpo.main_ray \
  ...
  trainer.experiment_name=infonce-alpha0015-ratioclip-predinopt-bestseed3x-Qwen2.5-3B-Instruct-20260722_091453 \
  trainer.default_local_dir=checkpoints/grpo-qwen-3b/infonce-alpha0015-ratioclip-predinopt-Qwen2.5-3B-Instruct-20260722_091453 \
  ...
  +trainer.validation_seeds=[31415,31415,31415] \
