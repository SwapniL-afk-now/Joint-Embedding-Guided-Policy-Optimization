...
export PREDICTOR_EMBED_LR=0
export PREDICTOR_EMBED_WD=0.0
...
exec /workspace/exploration/.venv/bin/python3 -m verl.experimental.jepa_grpo.main_ray \
  ...
  trainer.experiment_name=infonce-alpha0015-ratioclip-Qwen2.5-3B-Instruct-20260721_193000 \
  trainer.default_local_dir=checkpoints/grpo-qwen-3b/infonce-alpha0015-ratioclip-Qwen2.5-3B-Instruct-20260721_193000 \
