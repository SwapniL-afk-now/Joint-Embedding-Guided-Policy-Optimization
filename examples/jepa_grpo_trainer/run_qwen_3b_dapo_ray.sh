...
# DAPO with the JEPA/TCR-dual auxiliary objective enabled by default.
...
PROJECT_NAME=${PROJECT_NAME:-dapo_jepa}
...
MODEL=(
    ...
    actor_rollout_ref.model.enable_gradient_checkpointing=${ENABLE_GRAD_CKPT:-False}
